...
async function generateSiteWithStitch(companyName, city, primaryColor = '#0066cc', category = 'business') {
...
function generateMockPage(companyName, city, primaryColor, category) {
    const htmlContent = `
<!DOCTYPE html>
